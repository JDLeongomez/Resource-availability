...
mods.comp <- function(base.model) {
  ...
  taa <- kable(tab,
    ...
    footnote(general = "Models are sorted according tho their $AICc$ values, increasingly, 
...
```{r}
plot.best.mod <- function(best_model, y.pos) {
...
pm1f <- plot.best.mod(best_model = best_m1_cov, y.pos = c(300, NA, 280, 300,NA, NA, 300, NA))
pm1f
```
