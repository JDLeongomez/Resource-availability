...
\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-10}Difference in independent masculinity ratings given to each stimulus,
...
\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-14}Correlation between variables and PCA dimensions}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\begin{tabular}[t]{lcc}
\toprule
...
\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-25}Correlations between partner violence and responses to masculinized and 
        feminized stimuli}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\begin{threeparttable}
...
\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-26}Mean scores and comparison of resource availability dimensions by condition}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\begin{threeparttable}
\begin{tabular}[t]{lccccc}
...
\subsection{Model 1: Duration of First Fixations (DFF)}\label{model-1-duration-of-first-fixations-dff}
...
\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-29}Estimated marginal and constrast between masculinized and feminized 
...
\subsection{Model 2: Total Fixation Duration (TFD)}\label{model-2-total-fixation-duration-tfd}
...
\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-32}Estimated marginal and constrast between masculinized and feminized 
...
\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-33}Estimated marginal and constrast between Sexual dimorphism levels by Relationship for the TFD model}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\begin{threeparttable}
...
\paragraph{Full design}\label{full-design-1}
...
\subsection{Model 3: Number of Fixations (NF)}\label{model-3-number-of-fixations-nf}
...
\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-36}Estimated marginal and constrast between masculinized and feminized 
...
\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-37}Estimated marginal and constrast between Relationship levels by Condition for the NF model}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\begin{threeparttable}
\begin{tabular}[t]{llcccccccc}
...
\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-38}Estimated marginal and constrast between Sexual dimorphism levels by Relationship for the NF model}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\begin{threeparttable}
\begin{tabular}[t]{llcccccccc}
...
\paragraph{Full design}\label{full-design-2}
...
\subsection{Model 4: Proportion of Chosen Faces (PCF)}\label{model-4-proportion-of-chosen-faces-pcf}
...
\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-41}Estimated marginal and constrast between masculinized and feminized 
...
\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-42}Estimated marginal and constrast between Sexual dimorphism levels by Relationship for the PCF model}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\begin{threeparttable}
\begin{tabular}[t]{llcccccccc}
...
\paragraph{Full design}\label{full-design-3}
...
\StringTok{  linear mixed models, and unadjusted and adjuster $R\^{}2$ for the PCF linear model), see tables}
\StringTok{  }\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{@ref(tab:tab{-}mod1), }\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{@ref(tab:tab{-}mod2), }\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{@ref(tab:tab{-}mod3) and }\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{@ref(tab:tab{-}mod4) in }
\StringTok{  the Supplementary Material. Significant effects are in bold."}\NormalTok{,}
           \AttributeTok{threeparttable =} \ConstantTok{TRUE}\NormalTok{, }
           \AttributeTok{footnote\_as\_chunk =} \ConstantTok{TRUE}\NormalTok{, }
           \AttributeTok{escape =} \ConstantTok{FALSE}\NormalTok{)}
\end{Highlighting}
...
\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-43}Pattern of gaze and choice of face by resource availability condition, 
...
\item For models predicting fixation measurements (DFF, TFD, and NF) results 
  ...
  linear mixed models, and unadjusted and adjuster $R^2$ for the PCF linear model), see tables
  \ref{tab:tab-mod1}, \ref{tab:tab-mod2}, \ref{tab:tab-mod3} and \ref{tab:tab-mod4} in 
  the Supplementary Material. Significant effects are in bold.
\end{tablenotes}
\end{threeparttable}}
\end{table}
