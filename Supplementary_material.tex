...
\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-19}Number and age of participants in each condition}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
...
\centering
\caption{\label{tab:unnamed-chunk-22}Correlations between XXXXXX}
\centering
...
\begin{landscape}\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-23}Correlations between fixations, subjective evaluations of stimuli, 
...
\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-24}Correlations between partner violence and mean difference scores between 
...
\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-25}Mean scores and comparison of resource availability dimensions by condition}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\begin{threeparttable}
\begin{tabular}[t]{lccccc}
