...
\subsubsection{Last partner perception}\label{last-partner-perception}
...
\subsubsection{Correlations in partner perceptions}\label{correlations-in-partner-perceptions}
...
\NormalTok{    Partner\_attractiveness) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{rename}\NormalTok{(}
    \StringTok{"PPV"} \OtherTok{=} \StringTok{"Freq\_partner\_physical\_violence"}\NormalTok{,}
  ...
  \FunctionTok{ggcorr}\NormalTok{(}\AttributeTok{geom =} \StringTok{"blank"}\NormalTok{, }\AttributeTok{label =} \ConstantTok{TRUE}\NormalTok{, }\AttributeTok{label\_size =} \DecValTok{2}\NormalTok{,}
         \AttributeTok{hjust =} \FloatTok{0.75}\NormalTok{, }\AttributeTok{label\_round =} \DecValTok{3}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{size =} \DecValTok{10}\NormalTok{, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{color =}\NormalTok{ coefficient }\SpecialCharTok{\textgreater{}} \DecValTok{0}\NormalTok{, }\AttributeTok{alpha =} \FunctionTok{abs}\NormalTok{(coefficient) }\SpecialCharTok{\textgreater{}} \FloatTok{0.5}\NormalTok{)) }\SpecialCharTok{+}
  ...
  \FunctionTok{guides}\NormalTok{(}\AttributeTok{color =} \ConstantTok{FALSE}\NormalTok{, }\AttributeTok{alpha =} \ConstantTok{FALSE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{Supplementary_material_files/figure-latex/unnamed-chunk-20-1.pdf}

\subsubsection{Correlations table (general)}\label{correlations-table-general}
...
\NormalTok{         Freq\_partner\_infidelity) }\SpecialCharTok{|\textgreater{}} 
  ...
  \FunctionTok{rename\_with}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\FunctionTok{str\_replace\_all}\NormalTok{(., }\StringTok{"SP "}\NormalTok{, }\StringTok{""}\NormalTok{)) }\SpecialCharTok{|\textgreater{}}
  ...
  \FunctionTok{rename\_with}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\FunctionTok{str\_replace\_all}\NormalTok{(., }\StringTok{"Partner attr."}\NormalTok{, }\StringTok{"Attractive."}\NormalTok{)) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{rename\_with}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\FunctionTok{str\_replace\_all}\NormalTok{(., }\StringTok{"Dominance"}\NormalTok{, }\StringTok{"Dom."}\NormalTok{)) }\SpecialCharTok{|\textgreater{}}
...
\NormalTok{  dplyr}\SpecialCharTok{::}\FunctionTok{slice}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{) }\SpecialCharTok{|\textgreater{}} 
  ...
  \FunctionTok{kable\_styling}\NormalTok{(}\AttributeTok{latex\_options =} \FunctionTok{c}\NormalTok{(}\StringTok{"HOLD\_position"}\NormalTok{),}
                \AttributeTok{font\_size =} \DecValTok{5}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
  ...
  \FunctionTok{column\_spec}\NormalTok{(}\DecValTok{2}\SpecialCharTok{:}\DecValTok{21}\NormalTok{, }\AttributeTok{width =} \StringTok{"0.7cm"}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
...
\centering
\caption{\label{tab:unnamed-chunk-21}Correlations between XXXXXX}
\centering
\fontsize{5}{7}\selectfont
\begin{threeparttable}
\begin{tabular}[t]{>{\raggedright\arraybackslash}p{1.2cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}}
\toprule
...
\cmidrule(l{3pt}r{3pt}){2-2} \cmidrule(l{3pt}r{3pt}){3-3} \cmidrule(l{3pt}r{3pt}){4-10} \cmidrule(l{3pt}r{3pt}){11-13} \cmidrule(l{3pt}r{3pt}){14-19} \cmidrule(l{3pt}r{3pt}){20-21}
  & Age & Frequency of illness & Happiness & Financial security & Money control & Attr. & Self confidence & Self esteem & Health & Masc. & Dominance & Attractive. &  Country safety &  City safety &  Neighborhood safety &  Home safety &  Safety & Frequency of robery & Physical violence & Sexual violence\\
\midrule
Frequency of illness & -0.03 &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & \\
Happiness & -0.05 & \textbf{-0.2***} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & \\
Financial security & -0.1$^{\dagger}$ & -0.06 & \textbf{0.59***} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & \\
Money control & 0.03 & \textbf{-0.18**} & \textbf{0.48***} & \textbf{0.62***} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & \\
Attr. & -0.06 & \textbf{-0.16**} & \textbf{0.68***} & \textbf{0.46***} & \textbf{0.51***} &  &  &  &  &  &  &  &  &  &  &  &  &  &  & \\
Self confidence & -0.07 & \textbf{-0.25***} & \textbf{0.73***} & \textbf{0.48***} & \textbf{0.51***} & \textbf{0.87***} &  &  &  &  &  &  &  &  &  &  &  &  &  & \\
Self esteem & -0.06 & \textbf{-0.25***} & \textbf{0.75***} & \textbf{0.49***} & \textbf{0.53***} & \textbf{0.84***} & \textbf{0.93***} &  &  &  &  &  &  &  &  &  &  &  &  & \\
Health & -0.02 & \textbf{-0.26***} & \textbf{0.69***} & \textbf{0.45***} & \textbf{0.45***} & \textbf{0.68***} & \textbf{0.72***} & \textbf{0.73***} &  &  &  &  &  &  &  &  &  &  &  & \\
Masc. & \textbf{0.14*} & -0.1$^{\dagger}$ & \textbf{0.17**} & \textbf{0.18**} & \textbf{0.18**} & \textbf{0.21***} & \textbf{0.22***} & \textbf{0.25***} & \textbf{0.2***} &  &  &  &  &  &  &  &  &  &  & \\
Dominance & 0.05 & -0.08 & \textbf{0.13*} & \textbf{0.17**} & \textbf{0.14*} & \textbf{0.17**} & \textbf{0.15**} & \textbf{0.19**} & \textbf{0.12*} & \textbf{0.72***} &  &  &  &  &  &  &  &  &  & \\
Attractive. & \textbf{0.13*} & -0.05 & \textbf{0.17**} & \textbf{0.18**} & \textbf{0.19**} & \textbf{0.18**} & \textbf{0.19**} & \textbf{0.23***} & \textbf{0.18**} & \textbf{0.78***} & \textbf{0.6***} &  &  &  &  &  &  &  &  & \\
...
Neighborhood safety & 0.11$^{\dagger}$ & -0.04 & \textbf{0.12*} & -0.08 & 0.00 & \textbf{0.12*} & 0.09 & 0.09 & 0.06 & 0.03 & 0.02 & -0.03 & \textbf{0.32***} & \textbf{0.32***} &  &  &  &  &  & \\
...
\subsubsection{Correlations table (fixations, subjective evaluations and violence)}\label{correlations-table-fixations-subjective-evaluations-and-violence}
...
\NormalTok{dat\_main\_corr }\SpecialCharTok{|\textgreater{}} 
...
\NormalTok{  dplyr}\SpecialCharTok{::}\FunctionTok{slice}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{) }\SpecialCharTok{|\textgreater{}} 
  ...
  \FunctionTok{add\_header\_above}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{" "}\NormalTok{, }
                     ...
                     \StringTok{"Current/last partner}\SpecialCharTok{\textbackslash{}n}\StringTok{perception"} \OtherTok{=} \DecValTok{3}\NormalTok{,}
                     \StringTok{"Perceived context}\SpecialCharTok{\textbackslash{}n}\StringTok{violence"} \OtherTok{=} \DecValTok{6}\NormalTok{,}
                     \StringTok{"Frequency of partner}\SpecialCharTok{\textbackslash{}n}\StringTok{violence"} \OtherTok{=} \DecValTok{2}\NormalTok{),}
                   \AttributeTok{bold =} \ConstantTok{TRUE}\NormalTok{) }\SpecialCharTok{|\textgreater{}} 
  \FunctionTok{footnote}\NormalTok{(}\AttributeTok{general =} \FunctionTok{paste0}\NormalTok{(}\StringTok{"Values represent Pearson correlation coefficients ($r$). "}\NormalTok{,}
                            \StringTok{"For significance, $\^{}\{}\SpecialCharTok{\textbackslash{}\textbackslash{}\textbackslash{}\textbackslash{}}\StringTok{dagger\}p$ \textless{} 0.1, *$p$ \textless{} 0.05, "}\NormalTok{,}
                            \StringTok{"**$p$ \textless{} 0.01, ***$p$ \textless{} 0.001. "}\NormalTok{,}
...
\fontsize{5}{7}\selectfont
\begin{threeparttable}
\begin{tabular}[t]{>{\raggedright\arraybackslash}p{1.2cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{\centering\arraybackslash}p{0.7cm}>{}p{0.7cm}>{}p{0.7cm}>{}p{0.7cm}}
\toprule
\multicolumn{1}{c}{\textbf{ }} & \multicolumn{1}{c}{\textbf{Age}} & \multicolumn{1}{c}{\textbf{Health}} & \multicolumn{7}{c}{\textbf{Self-perceived conditions}} & \multicolumn{3}{c}{\textbf{\makecell[c]{Current/last partner\\perception}}} & \multicolumn{6}{c}{\textbf{\makecell[c]{Perceived context\\violence}}} & \multicolumn{2}{c}{\textbf{\makecell[c]{Frequency of partner\\violence}}} \\
\cmidrule(l{3pt}r{3pt}){2-2} \cmidrule(l{3pt}r{3pt}){3-3} \cmidrule(l{3pt}r{3pt}){4-10} \cmidrule(l{3pt}r{3pt}){11-13} \cmidrule(l{3pt}r{3pt}){14-19} \cmidrule(l{3pt}r{3pt}){20-21}
  & TFD & DFF & NF & Masculinity & Attractiveness & Partner attractiveness & Partner dominance & Partner masculinity & Perceived country safety & Perceived city safety & Perceived neighborhood safety & Perceived home safety & Perceived safety & Condition physical safety & Frequency of robery & Partner physical violence & Partner sexual violence\\
\midrule
DFF & -0.03 &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & \\
NF & \textbf{0.82***} & \textbf{-0.62***} &  &  &  &  &  &  &  &  &  &  &  &  &  &  & \\
Masculinity & \textbf{0.13*} & 0.07 & 0.06 &  &  &  &  &  &  &  &  &  &  &  &  &  & \\
Attractiveness & 0.02 & \textbf{-0.13*} & 0.08 & \textbf{0.49***} &  &  &  &  &  &  &  &  &  &  &  &  & \\
Partner attractiveness & -0.04 & 0.05 & -0.05 & 0.00 & -0.01 &  &  &  &  &  &  &  &  &  &  &  & \\
Partner dominance & -0.07 & -0.03 & -0.05 & -0.04 & -0.01 & \textbf{0.63***} &  &  &  &  &  &  &  &  &  &  & \\
Partner masculinity & -0.07 & 0.08 & -0.11$^{\dagger}$ & -0.01 & -0.03 & \textbf{0.75***} & \textbf{0.71***} &  &  &  &  &  &  &  &  &  & \\
Perceived country safety & -0.05 & -0.05 & -0.08 & \textbf{0.14*} & 0.05 & -0.06 & -0.03 & -0.05 &  &  &  &  &  &  &  &  & \\
Perceived city safety & -0.03 & -0.08 & -0.03 & \textbf{0.12*} & 0.00 & -0.06 & 0.02 & -0.02 & \textbf{0.82***} &  &  &  &  &  &  &  & \\
Perceived neighborhood safety & -0.1$^{\dagger}$ & 0.00 & -0.1$^{\dagger}$ & \textbf{0.18**} & \textbf{0.24***} & 0.01 & 0.00 & 0.05 & \textbf{0.38***} & \textbf{0.34***} &  &  &  &  &  &  & \\
Perceived home safety & -0.09 & 0.08 & -0.07 & 0.04 & \textbf{0.12*} & \textbf{-0.11*} & \textbf{-0.12*} & -0.05 & \textbf{-0.16**} & \textbf{-0.21***} & \textbf{0.34***} &  &  &  &  &  & \\
Perceived safety & \textbf{-0.11*} & -0.01 & \textbf{-0.11*} & \textbf{0.18**} & \textbf{0.17**} & -0.09$^{\dagger}$ & -0.06 & -0.03 & \textbf{0.68***} & \textbf{0.63***} & \textbf{0.8***} & \textbf{0.51***} &  &  &  &  & \\
Condition physical safety & 0.01 & 0.05 & 0.00 & 0.08 & 0.00 & 0.09$^{\dagger}$ & 0.07 & 0.1$^{\dagger}$ & -0.03 & \textbf{-0.11*} & 0.02 & -0.11$^{\dagger}$ & -0.09 &  &  &  & \\
Frequency of robery & -0.01 & 0.08 & -0.04 & 0.05 & \textbf{0.13*} & -0.04 & -0.08 & -0.03 & 0.08 & 0.06 & \textbf{0.18**} & \textbf{0.15**} & \textbf{0.19***} & -0.09 &  &  & \\
Partner physical violence & 0.09$^{\dagger}$ & -0.12$^{\dagger}$ & 0.08 & 0.08 & 0.00 & 0.00 & 0.06 & 0.01 & \textbf{0.13*} & \textbf{0.14**} & \textbf{0.17**} & 0.08 & \textbf{0.2***} & -0.02 & -0.03 &  & \\
Partner sexual violence & \textbf{0.12*} & -0.07 & \textbf{0.15**} & -0.04 & 0.01 & 0.07 & 0.1$^{\dagger}$ & 0.05 & 0.02 & 0.1$^{\dagger}$ & -0.01 & -0.07 & 0.00 & 0.05 & -0.02 & 0.09$^{\dagger}$ & \\
Partner infidelity & -0.02 & 0.07 & -0.02 & -0.05 & 0.04 & 0.08 & 0.06 & 0.08 & \textbf{0.12*} & 0.07 & \textbf{0.18**} & 0.02 & \textbf{0.14**} & -0.01 & 0.01 & \textbf{0.13*} & -0.03\\
\bottomrule
\end{tabular}
\begin{tablenotes}[para]
\item \textit{Note: } 
