...
\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-31}Estimated marginal and constrast between masculinized and feminized 
...
\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-34}Estimated marginal and constrast between masculinized and feminized 
                           stimuli for the TFD model}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\begin{threeparttable}
\begin{tabular}[t]{lcccccccc}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tab\_m3 }\OtherTok{\textless{}{-}} \FunctionTok{lmer.anova.tab}\NormalTok{(}\AttributeTok{model =}\NormalTok{ mod3)}
...
Fixed effect & $F$ & $df$ & $p$\\
\midrule
Condition & 0.06 & 1, 284.69 & 0.8\\
Relationship & 0.20 & 1, 33903.87 & 0.66\\
Sexual dimorphism & 31.82 & 1, 291.54 & \textbf{< 0.0001}\\
Condition × Relationship & 4.12 & 1, 33904.02 & \textbf{0.0425}\\
Condition × Sexual dimorphism & 0.74 & 1, 291.54 & 0.39\\
Relationship × Sexual dimorphism & 16.30 & 1, 33914.21 & \textbf{< 0.0001}\\
Condition × Relationship × Sexual dimorphism & 0.91 & 1, 33914.21 & 0.34\\
\addlinespace[0.3em]
\hline
\multicolumn{4}{l}{\textbf{Nakagawa's $R^2$}}\\
\hline
\hspace{1em}Conditional = 0.26 &  &  & \\
\hspace{1em}Marginal = 0.0057 &  &  & \\
\bottomrule
\end{tabular}}
\end{table}
...
\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-38}Estimated marginal and constrast between masculinized and feminized 
                           stimuli for the NF model}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\begin{threeparttable}
\begin{tabular}[t]{lcccccccc}
...
Sexual dimorphism & EMM & $SE$ & $2.5\%CI$ & $97.5\%CI$ & Difference & $SE$ & $z$ & $p$\\
\midrule
Masculinized & 3.63 & 0.05 & 3.53 & 3.73 & 0.25 & 0.04 & 5.64 & \textbf{< 0.0001}\\
Feminized & 3.38 & 0.06 & 3.27 & 3.49 &  &  &  & \\
\bottomrule
\end{tabular}
\begin{tablenotes}[para]
\item \textit{Note: } 
...
\paragraph{Interaction: Condition × Relationship}\label{interaction-condition-relationship}

Table of estimated marginal means and contrasts between short and long term relationship by condition.

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{inter.contr}\NormalTok{(}\AttributeTok{model =}\NormalTok{ mod3,}
            \AttributeTok{emm\_contr =} \FunctionTok{emmeans}\NormalTok{(mod3, pairwise }\SpecialCharTok{\textasciitilde{}}\NormalTok{ Relationship }\SpecialCharTok{|}\NormalTok{ Condition))}
\end{Highlighting}
\end{Shaded}

\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-39}Estimated marginal and constrast between Relationship levels by Condition for the NF model}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\begin{threeparttable}
\begin{tabular}[t]{llcccccccc}
...
\multicolumn{6}{c}{ } & \multicolumn{4}{c}{Contrasts (Masculinized - Feminized)} \\
\cmidrule(l{3pt}r{3pt}){7-10}
Condition & Relationship & EMM & $SE$ & $2.5\%CI$ & $97.5\%CI$ & Difference & $SE$ & $z$ & 
                        $p$\\
\midrule
High & Short term & 3.50 & 0.06 & 3.38 & 3.63 & -0.03 & 0.02 & -1.20 & 0.23\\

 & Long term & 3.53 & 0.06 & 3.40 & 3.65 &  &  &  & \\
\cmidrule{1-10}
Low & Short term & 3.51 & 0.07 & 3.37 & 3.65 & 0.04 & 0.02 & 1.65 & 0.10\\

 & Long term & 3.47 & 0.07 & 3.33 & 3.61 &  &  &  & \\
\bottomrule
\end{tabular}
\begin{tablenotes}[para]
\item \textit{Note: } 
...
\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-40}Estimated marginal and constrast between Sexual dimorphism levels by Relationship for the NF model}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\begin{threeparttable}
\begin{tabular}[t]{llcccccccc}
...
Relationship & Sexual dimorphism & EMM & $SE$ & $2.5\%CI$ & $97.5\%CI$ & Difference & $SE$ & $z$ & 
                        $p$\\
\midrule
Short term & Masculinized & 3.60 & 0.05 & 3.50 & 3.70 & 0.18 & 0.05 & 3.92 & \textbf{< 0.0001}\\

 & Feminized & 3.42 & 0.06 & 3.31 & 3.53 &  &  &  & \\
\cmidrule{1-10}
Long term & Masculinized & 3.66 & 0.05 & 3.55 & 3.76 & 0.31 & 0.05 & 6.68 & \textbf{< 0.0001}\\

 & Feminized & 3.34 & 0.06 & 3.23 & 3.46 &  &  &  & \\
\bottomrule
\end{tabular}
\begin{tablenotes}[para]
\item \textit{Note: } 
...
Condition & Relationship & Sexual dimorphism & EMM & $SE$ & $2.5\%CI$ & $97.5\%CI$ & Difference & $SE$ & $z$ & 
                        $p$\\
\midrule
High & Short term & Masculinized & 3.57 & 0.07 & 3.44 & 3.70 & 0.13 & 0.06 & 2.11 & \textbf{0.0348}\\

 &  & Feminized & 3.44 & 0.07 & 3.29 & 3.58 &  &  &  & \\

 & Long term & Masculinized & 3.67 & 0.07 & 3.54 & 3.80 & 0.29 & 0.06 & 4.69 & \textbf{< 0.0001}\\

 &  & Feminized & 3.38 & 0.07 & 3.24 & 3.53 &  &  &  & \\
\cmidrule{1-11}
Low & Short term & Masculinized & 3.63 & 0.08 & 3.48 & 3.78 & 0.24 & 0.07 & 3.37 & \textbf{< 0.001}\\

 &  & Feminized & 3.39 & 0.08 & 3.23 & 3.56 &  &  &  & \\

 & Long term & Masculinized & 3.64 & 0.08 & 3.49 & 3.79 & 0.33 & 0.07 & 4.77 & \textbf{< 0.0001}\\

 &  & Feminized & 3.31 & 0.08 & 3.14 & 3.47 &  &  &  & \\
\bottomrule
\end{tabular}
\begin{tablenotes}[para]
\item \textit{Note: } 
...
\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-44}Estimated marginal and constrast between Sexual dimorphism levels by Relationship for the PCF model}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\begin{threeparttable}
\begin{tabular}[t]{llcccccccc}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{bind\_cols}\NormalTok{(tab\_m1}\SpecialCharTok{$}\NormalTok{tab,}
          \FunctionTok{select}\NormalTok{(tab\_m2}\SpecialCharTok{$}\NormalTok{tab, }\SpecialCharTok{{-}}\StringTok{"Fixed effect"}\NormalTok{),}
          \FunctionTok{select}\NormalTok{(tab\_m3}\SpecialCharTok{$}\NormalTok{tab, }\SpecialCharTok{{-}}\StringTok{"Fixed effect"}\NormalTok{),}
          \FunctionTok{select}\NormalTok{(tab\_m4}\SpecialCharTok{$}\NormalTok{tab, }\SpecialCharTok{{-}}\StringTok{"Fixed effect"}\NormalTok{)) }\SpecialCharTok{|\textgreater{}} 
  ...
  \FunctionTok{kable}\NormalTok{(}\AttributeTok{digits =} \DecValTok{2}\NormalTok{,}
        ...
        \AttributeTok{col.names =} \FunctionTok{c}\NormalTok{(}\StringTok{"Fixed effect"}\NormalTok{,}
                     \FunctionTok{rep}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{"$F$"}\NormalTok{,}
                           \StringTok{"$df$"}\NormalTok{,}
                           \StringTok{"$p$"}\NormalTok{),}
                         \AttributeTok{times =} \DecValTok{4}\NormalTok{),}
                     \StringTok{"$}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{omega\^{}2\_p$"}\NormalTok{),}
        \AttributeTok{linesep =} \StringTok{""}\NormalTok{,}
...
\StringTok{  are from linear mixed models; for PCF, however, results are from a linear model without }
\StringTok{  random effects, so $}\SpecialCharTok{\textbackslash{}\textbackslash{}\textbackslash{}\textbackslash{}}\StringTok{omega\^{}2\_p$ effect sizes are reported for each term. For further }
...
\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-46}Pattern of gaze and choice of face by resource availability condition, 
...
Fixed effect & $F$ & $df$ & $p$ & $F$ & $df$ & $p$ & $F$ & $df$ & $p$ & $F$ & $df$ & $p$ & $\omega^2_p$\\
\midrule
Condition & 0.06 & 1, 290 & 0.8 & 0.02 & 1, 279.87 & 0.88 & 0.06 & 1, 284.69 & 0.8 & 0.05 & 1, 1156 & 0.82 & 0.00\\
Relationship & 0.08 & 1, 33368.84 & 0.77 & 1.31 & 1, 18832.3 & 0.25 & 0.20 & 1, 33903.87 & 0.66 & 0.02 & 1, 1156 & 0.89 & 0.00\\
Sexual dimorphism & 10.91 & 1, 285.13 & \textbf{0.0011} & 47.00 & 1, 279.46 & \textbf{< 0.0001} & 31.82 & 1, 291.54 & \textbf{< 0.0001} & 740.26 & 1, 1156 & \textbf{< 0.0001} & 0.39\\
Condition × Relationship & 0.14 & 1, 33369.04 & 0.71 & 3.71 & 1, 18834.01 & 0.05 & 4.12 & 1, 33904.02 & \textbf{0.0425} & 0.01 & 1, 1156 & 0.94 & 0.00\\
Condition × Sexual dimorphism & 0.01 & 1, 285.13 & 0.93 & 0.95 & 1, 275.61 & 0.33 & 0.74 & 1, 291.54 & 0.39 & 2.06 & 1, 1156 & 0.15 & 0.00\\
Relationship × Sexual dimorphism & 0.46 & 1, 33424.64 & 0.5 & 5.47 & 1, 18762.57 & \textbf{0.0194} & 16.30 & 1, 33914.21 & \textbf{< 0.0001} & 15.29 & 1, 1156 & \textbf{< 0.0001} & 0.01\\
Condition × Relationship × Sexual dimorphism & 1.25 & 1, 33424.51 & 0.26 & 0.05 & 1, 18764.97 & 0.82 & 0.91 & 1, 33914.21 & 0.34 & 1.13 & 1, 1156 & 0.29 & 0.00\\
\bottomrule
\end{tabular}
\begin{tablenotes}[para]
\item \textit{Note: } 
\item For models predicting fixation measurements (DFF, TFD, and NF) results 
  are from linear mixed models; for PCF, however, results are from a linear model without 
  random effects, so $\omega^2_p$ effect sizes are reported for each term. For further 
