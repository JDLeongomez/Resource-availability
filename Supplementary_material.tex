...
\NormalTok{  taa }\OtherTok{\textless{}{-}} \FunctionTok{kable}\NormalTok{(tab,}
    ...
    \FunctionTok{pack\_rows}\NormalTok{(}\StringTok{"Nakagawa\textquotesingle{}s $R\^{}2$"}\NormalTok{,}
              ...
              \AttributeTok{escape =} \ConstantTok{FALSE}\NormalTok{) }\CommentTok{\#|\textgreater{} }
    \CommentTok{\#row\_spec(n\_rows{-}1, align = "right") |\textgreater{} }
    \CommentTok{\#row\_spec(row = 8, align = "right")}
...
\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-6}Difference in independent masculinity ratings given to each stimulus,
...
\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-10}Correlation between variables and PCA dimensions}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\begin{tabular}[t]{lcc}
\toprule
...
\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-20}Number and age of participants in each condition}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
...
\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-22}Correlations between partner perceptions}
\centering
\begin{threeparttable}
\begin{tabular}[t]{lccccc}
\toprule
...
\centering
\caption{\label{tab:unnamed-chunk-23}Correlations between XXXXXX}
\centering
...
\begin{landscape}\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-24}Correlations between fixations, subjective evaluations of stimuli, 
...
\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-25}Correlations between partner violence and mean difference scores between 
...
\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-29}ANOVA-type table of fixed effects for the DFF model}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
