...
author:
  ...
  - name: '[Name masked for peer review]'
    ...
    institute: evoco
institute:
  - labpsiexp: '[Institution masked for peer review]'
  - costa: '[Institution masked for peer review]'
  - evoco: '[Institution masked for peer review]'
...
header-includes: 
  ...
  \pagestyle{fancy} 
  \usepackage{hanging}
  \lhead{[Authors masked for peer review]} 
...
[Authors masked for peer review] (in prep). \textit{Resource availability and experiences of partner violence shape facial masculinity preferences in Colombian women.}
\end{hangparas}
```

Data available from the Open Science Framework (OSF): <https://osf.io/p2wsc/?view_only=628d8eac02cd498c97c0983051dc1037>. All analyses were planned by [Name masked for peer review] and [Name masked for peer review]. This document and its underlying code were created in `R Markdown` by [Name masked for peer review] using \LaTeX.
